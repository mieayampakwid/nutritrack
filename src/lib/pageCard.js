 ...
 */
export const MEAL_LOG_DAY_CARD_RADIUS_CLASS = 'rounded-2xl'
...
export const MOBILE_DASHBOARD_CARD_SHELL =
  'max-md:rounded-2xl max-md:border-border/70 max-md:bg-white max-md:text-neutral-900 max-md:shadow-md max-md:ring-1 max-md:ring-black/[0.04]'
